...
function Customize() {
 ...
 <IoMdArrowRoundBack className="absolute top-[30px] left-[30px] text-white
      ...
      >
        ...
        <div
          className={` w-[70px] h-[140px] lg:w-[150px] lg:h-[250px] bg-[#020220] border-2
    ...
    cursor-pointer hover:border-4 hover:border-white flex items-center justify-center ${
      ...
      {selectedImage && (
        <button
          className="
        min-w-[150px] h-[60px] mt-[30px] text-black font-semibold bg-white rounded-full text-[19px] cursor-pointer"
