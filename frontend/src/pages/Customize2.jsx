...
function Customize2() {
  ...
  return (
    ...
    >
        <IoMdArrowRoundBack className="absolute top-[30px] left-[30px] text-white
      ...
      <input
        ...
        {assistantName && <button
          className="
        min-w-[300px] h-[60px] mt-[30px] text-black font-semibold bg-white rounded-full text-[19px] cursor-pointer"
