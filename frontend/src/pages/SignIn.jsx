...
function SignIn() {
  ...
  return (
    ...
    >
      <form
        className="w-[90%] h-[600px] max-w-[500px] bg-[#00000062] backdrop-blur shadow-lg shadow-black
      ...
      >
        ...
        <input
          ...
          placeholder="Email"
          className="w-full
            h-[60px] outline-none border-2 border-white bg-transparent text-white
        ...
        <div
          className="w-full
            h-[60px]  border-2 border-white bg-transparent text-white
        ...
        <button
          className="
        min-w-[150px] h-[60px] mt-[30px] text-black font-semibold bg-white rounded-full text-[19px]"
          disabled={loading}
        >
