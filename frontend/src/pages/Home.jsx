...
function Home() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute lg:hidden top-0 w-full h-full bg-[#00000053] backdrop-blur-lg 
      p-[20px] flex flex-col gap-[20px] items-start ${
      ...
      >
        ...
        <button
          className="
        min-w-[150px] h-[60px]  text-black  cursor-pointer font-semibold  bg-white rounded-full text-[19px]"
      ...
      <button
        className="
        min-w-[150px] h-[60px] mt-[30px] text-black hidden lg:block cursor-pointer font-semibold absolute top-[20px] right-[20px]  bg-white rounded-full text-[19px]"
        onClick={handleLogOut}
      >
        Log Out
      </button>
      ...
      <button
        className="
        min-w-[150px] h-[60px] mt-[30px] text-black hidden lg:block cursor-pointer font-semibold bg-white absolute top-[100px] right-[20px]  rounded-full text-[19px]
        px-[20px] py-[10px]"
        onClick={() => navigate("/customize")}
      >
        Customize Your Assistant
