...
const geminiResponse = async (command, assistantName, userName) => {
  try {
    ...
    -"response": A short voice-friendly reply, e.g., "sure, playing it now", "here look
    what i found", "today is tuesday", etc.
    
    
     Type meanings:
- "general": if it's a factual or informational question. aur agar koi 
aisa question puchta hai jiska answer tume pata hai usko bhi general category me rakho bas short
answer dena
